...
.btn-rounded {
    ...
    <section id="section1" className="container my-4 d-flex justify-content-center">
        <div className="row justify-content-center" style={{paddingTop: "20px"}}>
            ...
            <div className="col-4">
                <p><b>About us!</b> We are four adventurus 2nd year COMBUS students that have a diverse background and have visited numerous locations, here to provide you with some great insights which may influence your next trip decision!</p>
            </div>
          </div>
        </section>
